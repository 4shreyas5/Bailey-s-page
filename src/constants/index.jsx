...
export const plans = [
  {
    ...
    // priceMonthly: 19,
    // priceYearly: 12,
    caption: "Real results come from real strategies, support, and guidance. Here’s how the Skool community can help you",
    features: [
      "Proven Step-by-Step System: Learn exactly how to launch a successful digital product business on Etsy, even if you’ve never sold anything online before.",
      "AI-Driven Insights: Stay ahead of the trends with cutting-edge AI tools to help you identify profitable niches and designs.",
      "Live Monthly Q&A Sessions: Get your questions answered in real-time during our monthly Q&A calls.",
      "Personalized Support from Me: I share everything I’ve learned, including strategies, wins, and failures, to fast-track your success.",
      "Networking & Community: Connect with over 750 entrepreneurs who are on the same journey, ready to share advice, support, and encouragement.",
      "Access Anytime, Anywhere: Whether you’re a night owl or an early riser, you can learn and grow at your own pace."
    ],
