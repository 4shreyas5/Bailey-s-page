...
export const features = [
  {
    ...
    title: "Once you sign up",
    text: "You’ll instantly become part of a supportive group of fellow entrepreneurs who get your hustle",
    button: {
  ...
  },
  {
    ...
    title: "Access the Training & Tools",
    text: "Dive right in with our comprehensive course and resources. You'll find everything you need—from niche research to design tools and marketing strategies",
    button: {
  ...
  },
  {
    id: "2",
    icon: "/images/feature-2.png",
    caption: "Get Real-Time Support",
    title: "Get Real-Time Support",
    text: "Join our live Q&A sessions where you can ask questions, share ideas, and get feedback from both me and your peers",
    button: {
      icon: "/images/docs.svg",
      title: "Read the docs",
    },
  },
  {
    ...
    caption: "Secure & trustworthy",
    title: "Start Earning",
    text: "Put the strategies into action, launch your shop, and watch as you start generating income with your digital products on Etsy",
    button: {
      icon: "/images/docs.svg",
      title: "Read the docs",
    },
...
export const plans = [
  {
    ...
    features: [
      ...
      "Real-Time Q&A Sessions: Join our monthly live Q&A calls, where I answer your questions in real time to help you move forward faster. Missed a session? No worries, all calls are recorded",
      "Personalized Support: I’m sharing everything I’ve learned, from wins to failures, so you can avoid mistakes and hit success faster.",
      "Network with 750+ Entrepreneurs: You’re never alone. Connect with others on the same journey and get advice, feedback, and support anytime.",
      "Bonus Design Tutorials: Access exclusive tutorials to help you create eye-catching designs and optimize your workflow.",
      "Etsy Success Toolkit: Get the tools and strategies you need to turn your Etsy shop into a thriving business.",
      "Stay Ahead of Trends: Daily AI-driven prompts keep you on top of the latest trends, so your products stay in demand.",
      "Learn at Your Own Pace: Access everything whenever you want—whether you’re hustling at night or learning early in the morning."
    ],
